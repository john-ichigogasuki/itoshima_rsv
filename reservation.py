...
headers = {
    ...
    "Accept-Language": "ja",
    "Cookie": "taskasp_cu_ykd_starturl=%2fcu%2feg%2fykd402303.task; taskasp_cu_ykd_sppage=1; taskasp_cu_ykd_sessionid="+str(target_cookie),
    # "sec-ch-ua": '"Not/A)Brand";v="8", "Chromium";v="126", "Brave";v="126"',
    # "sec-ch-ua-mobile": "?1",
    # "sec-ch-ua-platform": "macOS",
    # "Sec-GPC": "1",
    "Host": "www.tast-asp.net",
    "Referer": "https://www.task-asp.net/cu/ykd402303/Top",
